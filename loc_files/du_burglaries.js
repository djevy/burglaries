        ...
        var du_buildTable = function(area, data) {
            ...
            var keyImage = function(keys, id) {
                for (i = 0; i < keys; i++) {
                    jq(`#du-crimes-${id}`).append('<img class="du-icon du-icon-crime" src="img/du_bls_key_icon.png" alt="Key">')
                }
            }
        ...
        var du_animateSlider = function(area, data) {
            ...
            jq("#du-slider-container").append(`                
                <div class="du-section du-section-slider">
                    ...
                    <div class="du-slider">
                        <img id="du-slider-background" alt="burglaries" src="img/du_bls_slider.png" />
                        <div id="du-slider-text"><span>Least</span><span>Most</span></div>

                        <div id="du-slider-handle" class="du-slider-handle">

                            <div id="du-slider-banner"><img class="du-slider-logo" alt="burglaries" src="img/du_bls_icon.png" /></div>
            ...
            /* revert webview - END */
                ...
                var getJsonGeoData = function(runOk, runKo) {
                    jq.ajax({
                        ...
                        timeout: 8000,
                        /* 2 seconds timeout*/
                        url: "./data/du_burglaries_map.json",
